...
Calcuate the scaled coefficents from the conditional censoring logistic (CCL) estimator 
...
Prepare the data for evaluating the metrics from ROC curve via kernel smoothing
